...
object AppStrings {
    ...
    val en: Map<String, String> = linkedMapOf(
        ...
        "color_chooser_hint" to "Tap one of the six main colors. It updates frames, glow and accents instantly.",
        ...
        "color_chooser_hint" to "Pick a main color, or drag the panel below for a custom shade. Color applies when you release your finger.",
        "custom_color" to "Custom color",
        "custom_color_hint" to "Drag on the square (saturation / brightness) and the rainbow bar (hue). Safer than RGB sliders.",
        "sources" to "sources",
    ...
    val fa: Map<String, String> = linkedMapOf(
        ...
        "color_chooser_hint" to "یکی از شش رنگ اصلی را لمس کنید. قاب‌ها، درخشش و رنگ‌های تأکیدی فوراً عوض می‌شوند.",
        ...
        "color_chooser_hint" to "یک رنگ اصلی انتخاب کنید، یا در پنل پایین سایهٔ دلخواه بکشید. رنگ وقتی انگشت را رها کنید اعمال می‌شود.",
        "custom_color" to "رنگ سفارشی",
        "custom_color_hint" to "روی مربع (اشباع / روشنایی) و نوار رنگین‌کمانی (فام) بکشید — امن‌تر از اسلایدر RGB.",
        "sources" to "منبع",
